...
def gblF_Main():
	...
	class MainC_wall():
		def __init__(self, info_ary, corners_2dA):
			self.screen_ins  = info_ary[0]
			self.corners_2dA = corners_2dA
			self.height, self.width = corners_2dA[1][1] - corners_2dA[0][1], corners_2dA[1][0] - corners_2dA[0][0]
		def draw(self):
			pygame.draw.rect(self.screen_ins, GREY_2, [self.corners_2dA[0][0], self.corners_2dA[0][1], self.width, self.height])
			pygame.draw.rect(self.screen_ins, BLACK, [self.corners_2dA[0][0], self.corners_2dA[0][1], self.width, self.height],3)
		def detect(self, pointCoord_ary):
			pass
